...
if __name__ == "__main__":
    ...
    #Validation("SAC", "./trained_models/test15/test15_2000000_steps.zip", eval_eps=1)
    #Validation("SAC", "./trained_models/test15/best_model/best_model.zip", eval_eps=1)
    #Validation("SAC", "./trained_models/test16/best_model/best_model.zip", eval_eps=1)
